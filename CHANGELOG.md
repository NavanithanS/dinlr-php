...
**Reservations**
- Added 7 helper methods to `Reservation` resource to gracefully manage status changes: `setBooked()`, `setArrived()`, `setSeated()`, `setCompleted()`, `setNoShow()`, `cancel()`, `setPendingPayment()`
